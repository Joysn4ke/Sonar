...
static colorSensor_e SENSOR_analyse_color(void)
{
	...
	colorSensor_e color;
	color = ACT_EXPANDER_COLOR_SENSOR_NONE;
...
//		debug_printf("%d, %d, %d, %d\n", red, green, blue, sensors[i].ambiant);
		...
		Sint32 colors_value[ACT_EXPANDER_COLOR_SENSOR_NB] = {0};
		colorSensor_e colors_id[ACT_EXPANDER_COLOR_SENSOR_NB] = {0};
		Uint8 nb = 0;
		...
		colors_id[nb] = ACT_EXPANDER_COLOR_SENSOR_RED;
		nb++;
		...
		colors_id[nb] = ACT_EXPANDER_COLOR_SENSOR_GREEN;
		nb++;
		...
		colors_id[nb] = ACT_EXPANDER_COLOR_SENSOR_BLUE;
		nb++;
		...
		colors_id[nb] = ACT_EXPANDER_COLOR_SENSOR_WHITE;
		nb++;
		...
		colors_id[nb] = ACT_EXPANDER_COLOR_SENSOR_BLACK;
		nb++;
